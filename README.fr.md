...
🇬🇧 [Read this document in English](README.md) — la version anglaise est la référence et peut être en avance sur celle-ci.
...
Ce projet est sous licence **MIT**. Consulter le fichier [LICENSE](LICENSE) pour plus de détails.
